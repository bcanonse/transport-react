...
export const CardAsignarVendedor = () => {
    ...
    const [cotizacion, setCotizacion] = React.useState(dataArg);
    ...
    const handleSubmit = async (evt) => {
        ...
        setErrorOrOk("");
        try {
            await updateCustomDoc("cotizaciones", dataArg.id, dataArg);
            setCotizacion(dataArg);
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form onSubmit={handleSubmit}>
                        <h6 className="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">
                            Asignar vendedor a cotizaci&oacute;n
                        </h6>
